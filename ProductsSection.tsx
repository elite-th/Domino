...
export const ProductsSection = forwardRef<HTMLDivElement, ProductsSectionProps>(({ animatedIceCreamId, animationProgress }, ref) => {
  return (
    <section className="h-screen w-screen relative z-30 bg-white flex flex-col justify-start pt-24 sm:justify-center sm:pt-0">
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-4xl sm:text-5xl md:text-6xl font-black text-[#4a2c2a]">محصولات ما</h2>
          <p className="mt-4 text-base sm:text-lg text-gray-600">یک طعم برای هر سلیقه‌ای</p>
        </motion.div>
