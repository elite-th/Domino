...
export const HeroSection = forwardRef<HTMLDivElement, HeroSectionProps>(({ iceCream, animationProgress }, ref) => {
  ...
  return (
    <section className="full-section w-screen flex items-center justify-center overflow-hidden relative bg-gradient-to-br from-white to-slate-100">
      <Navbar />
      <div className="container mx-auto px-4 z-10">
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          >
            <h1 className="text-4xl sm:text-5xl lg:text-7xl font-black text-slate-800 drop-shadow-xl leading-tight">
              طعم غنی <br />
              <span className={`bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-cyan-500`}>{iceCream.name}</span>
            </h1>
            <p className="max-w-md mx-auto md:mx-0 md:ml-auto mt-4 sm:mt-6 text-base sm:text-lg text-slate-600 drop-shadow-md">
      ...
      <motion.div 
        ...
        className="absolute bottom-10 animate-bounce text-gray-500 z-20">
